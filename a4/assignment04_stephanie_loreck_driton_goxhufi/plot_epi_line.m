...
% jeweils vetoren, x enthält alle x wert (start und end punkt) und für y
% genauso, hier erster x wert ist 1 und zweiter ist width of bild und dann
% nur noch y werte ausrechenen, weil man linie übers ganze bild haben will

% f*punkt gibt vector mit a b c, liniengleichung umstellen nach y und abc
% vektor einsetzten und für x=1 und x=bildbreite die y ausrechnen und dann
